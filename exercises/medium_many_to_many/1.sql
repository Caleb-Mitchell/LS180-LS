...
CREATE TABLE customers (
  ...
  name text NOT NULL,
  payment_token char(8) NOT NULL UNIQUE CHECK (payment_token = UPPER(payment_token)) CHECK (LENGTH(payment_token) = 8)
  -- LS solution with regular expressions
...
-- Can just use keyword UNIQUE as above in CREATE TABLE
